...
public class ControladorUsuarios extends ControladorBase {
    ...
    public String saveUser(@Valid User user, BindingResult result,
		 ...
		 * 
         */
        if (!userService.isSsoIdUnico(user.getId(), user.getSsoId())) {
     ...
     */
    @RequestMapping(value = {"/editar-usario-{ssoId}"}, method = RequestMethod.POST)
     ...
     */
    @RequestMapping(value = {"/eliminar-usuario-{ssoId}"}, method = RequestMethod.GET)
    public String deleteUser(@PathVariable String ssoId) {
        userService.eliminarPorSsoId(ssoId);
