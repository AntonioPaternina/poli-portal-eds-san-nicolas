...
/**
 * Clase de configuración de Spring con componentes relacionados con
 * persistencia
 *
...
@EnableJpaRepositories("co.com.estacionsannicolas.repositorios")
public class ConfiguracionPersistencia {

    private static final Logger LOGGER = LoggerFactory.getLogger(ConfiguracionPersistencia.class);
