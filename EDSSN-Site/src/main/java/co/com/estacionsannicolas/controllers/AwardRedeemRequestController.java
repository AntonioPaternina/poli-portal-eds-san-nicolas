...
public class AwardRedeemRequestController extends BaseController {
    ...
    public AwardRedeemRequestBean redeemAwardForUserAndCampaign(@RequestBody AwardRedeemRequestBean awardRedeemRequest) throws NotEnoughPointsToRedeemAwardException {
